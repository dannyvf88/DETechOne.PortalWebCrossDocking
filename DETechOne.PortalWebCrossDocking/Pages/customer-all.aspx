...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    <style>
        ...
        #modalCliente .form-section-title {
            margin: .5rem 0 .75rem;
            color: #6c757d;
            text-transform: uppercase;
            letter-spacing: .03em;
            ...
            <div class="col">
                <div class="page-description" style="display: flex; justify-content: space-between; align-items: center;">
                    ...
                    <div class="button-group" style="display: flex; gap: 5px; flex-direction: row;">
                        <button type="button" id="btnAddBox" class="btn btn-light btn-burger" data-bs-toggle="tooltip" data-bs-placement="top" title="Agregar caja"  style="width: 30px; height: 30px; padding: 0; display: flex; justify-content: center; align-items: center;" onclick="AddNewBox();">
